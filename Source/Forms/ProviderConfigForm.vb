...
Namespace Gravitybox.Forms
  ...
  Friend Class ProviderConfigForm
...
#Region " Windows Form Designer generated code "
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      WorkingCollection = New ProviderCollection(mainObject)
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Name = "ProviderConfigForm"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Provider Configuration"
...
#Region "Class Members"
    ...
    Private m_ProviderCollection As ProviderCollection
    Private WorkingCollection As ProviderCollection
...
#Region "Property Implmentations"
    ...
    Public Property ProviderCollection() As ProviderCollection
      Get
        Return m_ProviderCollection
      End Get
      Set(ByVal Value As ProviderCollection)
        m_ProviderCollection = Value

        Try
          'Load a working collection with objects
          Call WorkingCollection.FromXML(Me.ProviderCollection.ToXML)
          Call RefreshForm()
...
#Region "Methods"
    ...
    Private Sub RefreshForm()
      ...
      Try
        ...
        For Each Provider In Me.WorkingCollection
          Call Me.lstMembers.Items.Add(Provider.Text)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Dim Provider As Provider = WorkingCollection(index)
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        ...
        Dim provider As Gravitybox.Objects.Provider = WorkingCollection.Add("", GetNewName)
        DirtyKeys.Add(provider.Key, provider.Key)
        Call Me.lstMembers.Items.Add(provider.Text)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(WorkingCollection.IndexOfVisible(provider))
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub ProviderConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveForm()
      ...
      Try
        ProviderCollection.UpdateCollection(WorkingCollection, DirtyKeys)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Dim BaseName As String = MainObject.ProviderCollection.ObjectSingular
        Dim ii As Integer = 1
        Dim text As String = ""
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal ProviderIndex As Integer)

      Try
        'Index Key, Parent, PropertyItemCollection
        Me.PropertyGrid1.SelectedObject = WorkingCollection(ProviderIndex)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As System.Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
      ...
      Try
        If lstMembers.SelectedIndex <> -1 Then
          Dim index As Integer = lstMembers.SelectedIndex
          Dim element As Provider = Me.WorkingCollection(lstMembers.SelectedIndex)
