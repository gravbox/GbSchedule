...
Namespace Gravitybox.Forms
  ...
  Friend Class ResourceConfigForm
...
#Region " Windows Form Designer generated code "
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      WorkingCollection = New ResourceCollection(mainObject)
...
#Region "Class Members"
    ...
    Private WorkingCollection As ResourceCollection
    ...
    Public Property ResourceCollection() As ResourceCollection
      ...
      Set(ByVal Value As ResourceCollection)
        ...
        Try
          ...
          Call WorkingCollection.FromXML(Me.ResourceCollection.ToXML)
          Call RefreshForm()
...
#Region "Methods"
    ...
    Private Sub RefreshForm()
      ...
      Try
        ...
        For Each Resource In Me.WorkingCollection
          Call Me.lstMembers.Items.Add(Resource.Text)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Dim Resource As Resource = WorkingCollection(index)
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        ...
        Dim resource As Resource = WorkingCollection.Add("", GetNewName)
        DirtyKeys.Add(resource.Key, resource.Key)
        Call Me.lstMembers.Items.Add(resource.Text)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(WorkingCollection.IndexOf(resource))
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub ResourceConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveForm()
      ...
      Try
        ResourceCollection.UpdateCollection(WorkingCollection, DirtyKeys)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Dim BaseName As String = MainObject.ResourceCollection.ObjectSingular
        Dim ii As Integer = 1
        Dim text As String = ""
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal ResourceIndex As Integer)

      Try
        'Index Key, Parent, PropertyItemCollection
        Me.PropertyGrid1.SelectedObject = WorkingCollection(ResourceIndex)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As System.Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
      ...
      Try
        If lstMembers.SelectedIndex <> -1 Then
          Dim index As Integer = lstMembers.SelectedIndex
          Dim element As Resource = Me.WorkingCollection(lstMembers.SelectedIndex)
