...
Namespace Gravitybox.Forms
  ...
  Friend Class PriorityConfigForm
...
#Region " Windows Form Designer generated code "
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      WorkingPriorityCollection = New PriorityCollection(mainObject)
      AddHandler WorkingPriorityCollection.Refresh, AddressOf OnRefresh
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.PropertyGrid1.Size = New System.Drawing.Size(196, 240)
      ...
      Me.lstMembers.Size = New System.Drawing.Size(200, 240)
      ...
      Me.Name = "PriorityConfigForm"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Priority Configuration"
...
#Region "Class Members"
    ...
    Private m_PriorityCollection As PriorityCollection
    Private WorkingPriorityCollection As PriorityCollection
...
#Region "Property Implementations"
    ...
    Public Property PriorityCollection() As PriorityCollection
      Get
        Return m_PriorityCollection
      End Get
      Set(ByVal Value As PriorityCollection)
        m_PriorityCollection = Value

        Try
          'Load a working collection with objects
          Call WorkingPriorityCollection.FromXML(Me.PriorityCollection.ToXML)
          Call RefreshForm()
...
#Region "Methods"
    ...
    Private Sub RefreshForm()
      ...
      Try
        ...
        For Each Priority In Me.WorkingPriorityCollection
          Call Me.lstMembers.Items.Add(Priority.Text)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Changed = False
        Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenChangeButtonEventArgs(Me.WorkingPriorityCollection, index, index - 1)
        ...
        Dim Priority As Priority = WorkingPriorityCollection(index)
        Call WorkingPriorityCollection.RemoveAt(index)
        Call WorkingPriorityCollection.AddObject(Priority, index - 1)
        Call RefreshForm()
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        ...
        'Raise event for cancel
        Changed = False
        Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenStandardButtonEventArgs(Me.WorkingPriorityCollection)
        Me.DialogSettings.OnAddButtonClick(eventParam)
        If eventParam.Cancel Then Return
        'If the collection was modified then do not proceed
        If Changed Then Return

        Dim Priority As Priority = WorkingPriorityCollection.Add("", GetNewName)
        DirtyKeys.Add(Priority.Key, Priority.Key)
        Call Me.lstMembers.Items.Add(Priority.Text)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(WorkingPriorityCollection.IndexOf(Priority))
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
      ...
      Try
        If Not (Me.lstMembers.SelectedItem Is Nothing) Then
          ...
          'Raise event for cancel
          Changed = False
          Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenChangeButtonEventArgs(Me.WorkingPriorityCollection, index, -1)
          Me.DialogSettings.OnDeleteButtonClick(eventParam)
          If eventParam.Cancel Then Return
          'If the collection was modified then do not proceed
          If Changed Then Return

          Me.WorkingPriorityCollection.RemoveAt(index)
          Call RefreshForm()
    ...
    Private Sub PriorityConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveForm()
      ...
      Try
        PriorityCollection.UpdateCollection(WorkingPriorityCollection, DirtyKeys)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Dim BaseName As String = MainObject.PriorityCollection.ObjectSingular
        Dim ii As Integer = 1
        Dim text As String = ""
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal PriorityIndex As Integer)

      Try
        'Index Key, Parent, PropertyItemCollection
        Me.PropertyGrid1.SelectedObject = WorkingPriorityCollection(PriorityIndex)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As System.Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
      ...
      Try
        If lstMembers.SelectedIndex <> -1 Then
          Dim index As Integer = lstMembers.SelectedIndex
          Dim element As Priority = Me.WorkingPriorityCollection(lstMembers.SelectedIndex)
