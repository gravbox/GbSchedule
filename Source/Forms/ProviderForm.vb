...
#Region "Class Members"
    ...
    Private m_DialogSettings As ProviderDialogSettings
...
#Region "Property Implementations"
		...
		Public Property DialogSettings() As ProviderDialogSettings
			Get
				Return m_DialogSettings
			End Get
			Set(ByVal Value As ProviderDialogSettings)
...
#Region "Methods"
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
      ...
      Try
        ...
        For ii = 0 To lstList.CheckedItems.Count - 1
          Call Appointment.ProviderList.Add(Me.ProviderCollection(lstList.Items.IndexOf(lstList.CheckedItems(ii))))
        Next
    ...
    Private Sub RefreshForm()
      ...
      Try
        If Me.ProviderCollection Is Nothing Then Return
        If Me.Appointment Is Nothing Then Return

        'Load the list with items
        Dim provider As provider
        Call lstList.Items.Clear()
        For Each provider In Me.ProviderCollection
          Call lstList.Items.Add(provider.Text, Appointment.ProviderList.Contains(provider))
        Next
    ...
    Private Sub ProviderForm_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize

      Try
        If Not (MainObject Is Nothing) Then
          MainObject.Dialogs.DialogProviderBounds = New Rectangle(Me.Left, Me.Top, Me.Width, Me.Height)
        End If
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub ProviderForm_Move(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Move
      If Not (MainObject Is Nothing) Then
        MainObject.Dialogs.DialogProviderBounds = New Rectangle(Me.Left, Me.Top, Me.Width, Me.Height)
      End If
    End Sub
