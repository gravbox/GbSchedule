...
Namespace Gravitybox.Forms
  ...
  Friend Class CategoryConfigForm
...
#Region " Windows Form Designer generated code "
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      WorkingCollection = New CategoryCollection(mainObject)
...
#Region "Class Members"
    ...
    Private WorkingCollection As CategoryCollection
    ...
    Public Property CategoryCollection() As CategoryCollection
      ...
      Set(ByVal Value As CategoryCollection)
        ...
        Try
          ...
          Call WorkingCollection.FromXML(Me.CategoryCollection.ToXML)
          Call RefreshForm()
...
#Region "Methods"
    ...
    Private Sub RefreshForm()
      ...
      Try
        ...
        For Each category In Me.WorkingCollection
          Call Me.lstMembers.Items.Add(category.Text)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Dim category As Gravitybox.Objects.Category = WorkingCollection(index)
    ...
    Private Sub cmdDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDown.Click
      ...
      Try
        ...
        Dim category As category = WorkingCollection(index)
        WorkingCollection.SetIndex(index, index + 1)
        Call RefreshForm()
        lstMembers.SelectedIndex = index + 1
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        ...
        Dim category As category = WorkingCollection.Add("", GetNewName)
        DirtyKeys.Add(category.Key, category.Key)
        Call Me.lstMembers.Items.Add(category.Text)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(WorkingCollection.IndexOf(category))
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub CategoryConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveForm()
      ...
      Try
        CategoryCollection.UpdateCollection(WorkingCollection, DirtyKeys)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Dim BaseName As String = MainObject.CategoryCollection.ObjectSingular
        Dim ii As Integer = 1
        Dim text As String = ""
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal CategoryIndex As Integer)

      Try
        'Index Key, Parent, PropertyItemCollection
        Me.PropertyGrid1.SelectedObject = WorkingCollection(CategoryIndex)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As System.Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
      ...
      Try
        If lstMembers.SelectedIndex <> -1 Then
          Dim index As Integer = lstMembers.SelectedIndex
          Dim element As Category = Me.WorkingCollection(lstMembers.SelectedIndex)
