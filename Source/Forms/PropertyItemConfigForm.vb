...
Namespace Gravitybox.Forms
  ...
  Friend Class PropertyItemConfigForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Name = "PropertyItemConfigForm"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Property Configuration"
...
#Region "Class Members"
    ...
    Private m_PropertyItemCollection As PropertyItemCollection
    Private WorkingPropertyItemCollection As PropertyItemCollection
...
#Region "Property Implmentations"
    ...
    Public Property PropertyItemCollection() As PropertyItemCollection
      Get
        Return m_PropertyItemCollection
      End Get
      Set(ByVal Value As PropertyItemCollection)
        m_PropertyItemCollection = Value

        Try
          'Load a working collection with objects
          WorkingPropertyItemCollection = New PropertyItemCollection
          Call WorkingPropertyItemCollection.FromXML(Me.PropertyItemCollection.ToXML)
          Call RefreshForm()
          'Default to first item if one exists
          If Me.lstMembers.Items.Count > 0 Then Me.lstMembers.SelectedIndex = 0
          AddHandler WorkingPropertyItemCollection.Refresh, AddressOf OnRefresh
...
#Region "Methods"
		...
		Private Sub RefreshForm()
			...
			Try
				...
				For Each PropertyItem In Me.WorkingPropertyItemCollection
					Call Me.lstMembers.Items.Add(PropertyItem.Text)
				Next
				Call EnableButtons()
			Catch ex As Exception
				Call ErrorModule.SetErr(ex)
		...
		Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
			...
			Try
				...
				Changed = False
				Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenChangeButtonEventArgs(Me.WorkingPropertyItemCollection, index, index - 1)
				...
				Dim PropertyItem As PropertyItem = WorkingPropertyItemCollection(index)
				Call WorkingPropertyItemCollection.RemoveAt(index)
				Call WorkingPropertyItemCollection.AddObject(PropertyItem, index - 1)
				Call RefreshForm()
		...
		Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
			...
			Try
				...
				'Raise event for cancel
				Changed = False
				Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenStandardButtonEventArgs(Me.WorkingPropertyItemCollection)
				Me.DialogSettings.OnAddButtonClick(eventParam)
				If eventParam.Cancel Then Return
				'If the collection was modified then do not proceed
				If Changed Then Return

				Dim propertyItem As Gravitybox.Objects.PropertyItem = WorkingPropertyItemCollection.Add("", GetNewName, "")
				DirtyKeys.Add(propertyItem.Key, propertyItem.Key)
				Call Me.lstMembers.Items.Add(PropertyItem.Text)
				Me.lstMembers.SelectedItem = Me.lstMembers.Items(WorkingPropertyItemCollection.IndexOf(PropertyItem))
			Catch ex As Exception
				Call ErrorModule.SetErr(ex)
			End Try
		...
		Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
			...
			Try
				If Not (Me.lstMembers.SelectedItem Is Nothing) Then
					...
					'Raise event for cancel
					Changed = False
					Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenChangeButtonEventArgs(Me.WorkingPropertyItemCollection, index, -1)
					Me.DialogSettings.OnDeleteButtonClick(eventParam)
					If eventParam.Cancel Then Return
					'If the collection was modified then do not proceed
					If Changed Then Return

					Me.WorkingPropertyItemCollection.RemoveAt(index)
					Call RefreshForm()
		...
		Private Sub PropertyItemConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		Private Sub SaveForm()
			...
			Try
				PropertyItemCollection.UpdateCollection(WorkingPropertyItemCollection, DirtyKeys)
			Catch ex As Exception
				Call ErrorModule.SetErr(ex)
			End Try
		...
		Private Function GetNewName() As String
			...
			Try
				Const BaseName As String = "Property"
				Dim ii As Integer = 1
        Dim text As String = ""
				text = BaseName & ii
    ...
    End Function
		...
		Private Sub LoadObject(ByVal PropertyItemIndex As Integer)

			Try
				'Index Key, Parent, PropertyItemCollection
				Me.PropertyGrid1.SelectedObject = WorkingPropertyItemCollection(PropertyItemIndex)
			Catch ex As Exception
				Call ErrorModule.SetErr(ex)
			End Try
		...
		Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As System.Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
			...
			Try
				If lstMembers.SelectedIndex <> -1 Then
					Dim index As Integer = lstMembers.SelectedIndex
					Dim text As String = Me.WorkingPropertyItemCollection(lstMembers.SelectedIndex).Text
					If (CType(lstMembers.SelectedItem, String) <> text) Then
						lstMembers.Items.Insert(index, Me.WorkingPropertyItemCollection(lstMembers.SelectedIndex).Text)
