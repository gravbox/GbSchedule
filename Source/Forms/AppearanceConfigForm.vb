...
Namespace Gravitybox.Forms
  ...
  Friend Class AppearanceConfigForm
...
#Region " Windows Form Designer generated code "
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      WorkingAppearanceCollection = New AppearanceCollection(mainObject)
      AddHandler WorkingAppearanceCollection.Refresh, AddressOf OnRefresh
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.lblProperties.Location = New System.Drawing.Point(264, 12)
      Me.lblProperties.Name = "lblProperties"
      Me.lblProperties.Size = New System.Drawing.Size(188, 16)
      ...
      Me.PropertyGrid1.Location = New System.Drawing.Point(264, 36)
      Me.PropertyGrid1.Name = "PropertyGrid1"
      Me.PropertyGrid1.PropertySort = System.Windows.Forms.PropertySort.Alphabetical
      Me.PropertyGrid1.Size = New System.Drawing.Size(196, 232)
      ...
      'cmdDown
      '
      Me.cmdDown.Location = New System.Drawing.Point(224, 68)
      ...
      Me.cmdDelete.Location = New System.Drawing.Point(152, 282)
      ...
      Me.lblMembers.Location = New System.Drawing.Point(16, 12)
      ...
      'cmdUp
      '
      Me.cmdUp.Location = New System.Drawing.Point(224, 36)
      Me.cmdUp.Name = "cmdUp"
      ...
      Me.cmdAdd.Location = New System.Drawing.Point(80, 282)
      ...
      Me.lstMembers.Location = New System.Drawing.Point(16, 36)
      Me.lstMembers.Name = "lstMembers"
      Me.lstMembers.Size = New System.Drawing.Size(200, 225)
      ...
      Me.cmdCancel.Location = New System.Drawing.Point(376, 318)
      ...
      Me.cmdOK.Location = New System.Drawing.Point(288, 318)
      Me.cmdOK.Name = "cmdOK"
      ...
      Me.lblLine.Location = New System.Drawing.Point(16, 310)
      Me.lblLine.Name = "lblLine"
      Me.lblLine.Size = New System.Drawing.Size(442, 1)
      ...
      Me.Name = "AppearanceConfigForm"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Appearance Configuration"
...
#Region "Class Members"
    ...
    Private m_AppearanceCollection As AppearanceCollection
    Private WorkingAppearanceCollection As AppearanceCollection
...
#Region "Property Implementations"
    ...
    Public Property AppearanceCollection() As AppearanceCollection
      Get
        Return m_AppearanceCollection
      End Get
      Set(ByVal Value As AppearanceCollection)
        m_AppearanceCollection = Value

        Try
          'Load a working collection with objects
          Call WorkingAppearanceCollection.FromXML(Me.AppearanceCollection.ToXML)
          Call RefreshForm()
...
#Region "Methods"
    ...
    Private Sub RefreshForm()
      ...
      Try
        ...
        For Each Appearance In Me.WorkingAppearanceCollection
          Call Me.lstMembers.Items.Add(Appearance.Text)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Changed = False
        Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenChangeButtonEventArgs(Me.WorkingAppearanceCollection, index, index - 1)
        ...
        Dim Appearance As Appearance = WorkingAppearanceCollection(index)
        Call WorkingAppearanceCollection.RemoveAt(index)
        Call WorkingAppearanceCollection.AddObject(Appearance, index - 1)
        Call RefreshForm()
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        ...
        'Raise event for cancel
        Changed = False
        Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenStandardButtonEventArgs(Me.WorkingAppearanceCollection)
        Me.DialogSettings.OnAddButtonClick(eventParam)
        If eventParam.Cancel Then Return
        'If the collection was modified then do not proceed
        If Changed Then Return

        Dim appearance As Gravitybox.Objects.Appearance = WorkingAppearanceCollection.Add("", GetNewName)
        DirtyKeys.Add(appearance.Key, appearance.Key)
        Call Me.lstMembers.Items.Add(appearance.Text)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(WorkingAppearanceCollection.IndexOf(appearance))
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
      ...
      Try
        If Not (Me.lstMembers.SelectedItem Is Nothing) Then
          ...
          'Raise event for cancel
          Changed = False
          Dim eventParam As New Gravitybox.Objects.EventArgs.ConfigScreenChangeButtonEventArgs(Me.WorkingAppearanceCollection, index, -1)
          Me.DialogSettings.OnDeleteButtonClick(eventParam)
          If eventParam.Cancel Then Return
          'If the collection was modified then do not proceed
          If Changed Then Return

          Me.WorkingAppearanceCollection.RemoveAt(index)
          Call RefreshForm()
    ...
    Private Sub AppearanceConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveForm()
      ...
      Try
        AppearanceCollection.UpdateCollection(WorkingAppearanceCollection, DirtyKeys)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Dim BaseName As String = MainObject.AppearanceCollection.ObjectSingular
        Dim ii As Integer = 1
        Dim text As String = ""
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal AppearanceIndex As Integer)

      Try
        'Index Key, Parent, PropertyItemCollection
        Me.PropertyGrid1.SelectedObject = WorkingAppearanceCollection(AppearanceIndex)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
    ...
    Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As System.Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
      ...
      Try
        If lstMembers.SelectedIndex <> -1 Then
          Dim index As Integer = lstMembers.SelectedIndex
          Dim element As Appearance = Me.WorkingAppearanceCollection(lstMembers.SelectedIndex)
