...
Namespace Gravitybox.Objects.EventArgs
  ...
  Public Class BeforeAppointmentTextEventArgs
...
#Region "Constructor"
		...
		Protected Friend Sub New(ByVal appointment As Gravitybox.Objects.Appointment)
			...
			Me.Text = appointment.Subject
		End Sub

		'Public Not Creatable
		Protected Friend Sub New(ByVal appointment As Gravitybox.Objects.Appointment, ByVal text As String)
			MyBase.New(appointment)
			Me.Text = text
		End Sub
