...
Namespace Gravitybox.Design.Serializers
  ...
  Friend Class AppointmentHeaderAppearanceSerializer
    ...
    Public Overrides Function Deserialize(ByVal manager As System.ComponentModel.Design.Serialization.IDesignerSerializationManager, ByVal codeObject As Object) As Object
      Dim baseSerializer As CodeDomSerializer = CType(manager.GetSerializer(GetType(AppointmentHeaderAppearanceSerializer).BaseType, GetType(CodeDomSerializer)), CodeDomSerializer)
