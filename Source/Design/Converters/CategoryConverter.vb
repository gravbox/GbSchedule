...
Namespace Gravitybox.Design.Converters
  ...
  Friend Class CategoryConverter
...
#Region "Convert From"
    ...
    Public Overloads Overrides Function ConvertFrom(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object) As Object
      ...
      If TypeOf value Is String Then
        category = New Gravitybox.Objects.Category("", CType(value, String), "")
        Return category
      End If
...
#Region "Convert To"
    ...
    Public Overloads Overrides Function ConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As System.Type) As Object
      ...
      'Get a reference to the category object
      Dim category As Gravitybox.Objects.Category = CType(value, Gravitybox.Objects.Category)
      ...
      ElseIf destinationType Is GetType(InstanceDescriptor) Then
        ...
        Dim tp() As System.Type = {GetType(String), GetType(String), GetType(String), GetType(Color)}
				Dim objs() As Object = {category.Key, category.Text, category.Notes, category.Appearance.BackColor}
        Dim constructor As System.Reflection.ConstructorInfo = GetType(Gravitybox.Objects.Category).GetConstructor(tp)
