...
Namespace Gravitybox.Design.Converters
  ...
  Friend Class AppointmentTypeConverter
...
#Region "Convert From"
    ...
    Public Overloads Overrides Function ConvertFrom(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object) As Object
      ...
      Dim AppointmentType As Gravitybox.Objects.AppointmentType
      If TypeOf value Is String Then
        AppointmentType = New Gravitybox.Objects.AppointmentType("", CType(value, String), "")
...
#Region "Convert To"
    ...
    Public Overloads Overrides Function ConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As System.Type) As Object
      ...
      'Get a reference to the AppointmentType object
      Dim AppointmentType As Gravitybox.Objects.AppointmentType = CType(value, Gravitybox.Objects.AppointmentType)
      ...
      ElseIf destinationType Is GetType(InstanceDescriptor) Then
        ...
        Dim objs() As Object = {AppointmentType.Key, AppointmentType.Text, AppointmentType.Notes, AppointmentType.Color}
        Dim constructor As System.Reflection.ConstructorInfo = GetType(Gravitybox.Objects.AppointmentType).GetConstructor(tp)
