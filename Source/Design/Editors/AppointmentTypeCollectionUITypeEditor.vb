...
Namespace Gravitybox.Design.Editors
  ...
  Friend Class AppointmentTypeCollectionUITypeEditor
...
#Region "Edit Style"
    ...
    Public Overloads Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As System.IServiceProvider, ByVal value As Object) As Object
      ...
      dialogSettings.WindowText = "AppointmentType Configuration"

      Dim popupUI As New Forms.AppointmentTypeConfigForm(CType(value, AppointmentTypeCollection).GetMainObject)
      popupUI.DialogSettings = dialogSettings
      popupUI.AppointmentTypeCollection = CType(value, AppointmentTypeCollection)
