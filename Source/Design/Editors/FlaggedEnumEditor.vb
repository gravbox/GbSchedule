...
Namespace Gravitybox.Design.Editors
  ...
  Friend Class FlaggedEnumEditor
    Inherits System.Drawing.Design.UITypeEditor

    Dim ui As Gravitybox.Design.UIControls.FlaggedEnumControl
...
#Region "Edit Style"
    ...
    Public Overloads Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As System.IServiceProvider, ByVal value As Object) As Object
      ...
      'Create our UI
      If ui Is Nothing Then ui = New Gravitybox.Design.UIControls.FlaggedEnumControl

      'Initialize the UI
      ui.EnumerationObject = CType(value, [Enum])

      'Instruct the editor service to display the control as a dropdown.
			edSvc.DropDownControl(ui)
      Return ui.EnumerationObject
