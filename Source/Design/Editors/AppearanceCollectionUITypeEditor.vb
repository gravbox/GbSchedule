...
Namespace Gravitybox.Design.Editors
  ...
  Friend Class AppearanceCollectionUITypeEditor
...
#Region "Edit Style"
    ...
    Public Overloads Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As System.IServiceProvider, ByVal value As Object) As Object
      ...
      dialogSettings.WindowText = "Appointment Appearance Configuration"

      Dim popupUI As New Forms.AppearanceConfigForm(CType(value, AppearanceCollection).GetMainObject)
      popupUI.DialogSettings = dialogSettings
      popupUI.AppearanceCollection = CType(value, AppearanceCollection)
