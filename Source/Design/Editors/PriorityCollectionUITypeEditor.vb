...
Namespace Gravitybox.Design.Editors
  ...
  Friend Class PriorityCollectionUITypeEditor
...
#Region "Edit Style"
    ...
    Public Overloads Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As System.IServiceProvider, ByVal value As Object) As Object
      ...
      dialogSettings.WindowText = "Priority Configuration"

      Dim popupUI As New Forms.PriorityConfigForm(CType(value, PriorityCollection).GetMainObject)
      popupUI.DialogSettings = dialogSettings
      popupUI.PriorityCollection = CType(value, PriorityCollection)
