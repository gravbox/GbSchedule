...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "categorylist"
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          If Me.MainObject.CategoryCollection.Contains(xmlNode.InnerText) Then
            Call Me.Add(Me.MainObject.CategoryCollection(xmlNode.InnerText))
          End If
        Next
