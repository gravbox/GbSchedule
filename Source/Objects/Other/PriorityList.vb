...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "Prioritylist"
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          If Me.MainObject.PriorityCollection.Contains(xmlNode.InnerText) Then
            Call Me.Add(Me.MainObject.PriorityCollection(xmlNode.InnerText))
          End If
        Next
