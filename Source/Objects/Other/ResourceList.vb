...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "resourcelist"
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          If Me.MainObject.ResourceCollection.Contains(xmlNode.InnerText) Then
            Call Me.Add(Me.MainObject.ResourceCollection(xmlNode.InnerText))
          End If
        Next
