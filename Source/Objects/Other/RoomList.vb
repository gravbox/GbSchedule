...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "roomlist"
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          If Me.MainObject.RoomCollection.Contains(xmlNode.InnerText) Then
            Call Me.Add(Me.MainObject.RoomCollection(xmlNode.InnerText))
          End If
        Next
