...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "AppointmentTypelist"
...
#Region "XML"
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          If Me.MainObject.AppointmentTypeCollection.Contains(xmlNode.InnerText) Then
            Call Me.Add(Me.MainObject.AppointmentTypeCollection(xmlNode.InnerText))
          End If
        Next
    ...
    Friend Function XmlNode() As System.Xml.XmlNode
      ...
      Try
        ...
        Dim element As AppointmentType
