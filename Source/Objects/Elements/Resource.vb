...
Namespace Gravitybox.Objects
	...
	TypeConverter(GetType(Gravitybox.Design.Converters.ResourceConverter))> _
	Public Class Resource
		Inherits BaseObject

#Region "Class Members"

		Friend Const MyXMLNodeName As String = "resource"
...
#Region "Clone"
		...
		Friend Overrides Function CloneMe() As Object
			Try
				Dim element As New Gravitybox.Objects.Resource
