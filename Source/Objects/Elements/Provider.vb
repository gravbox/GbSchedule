...
Namespace Gravitybox.Objects
  ...
  TypeConverter(GetType(Gravitybox.Design.Converters.ProviderConverter))> _
...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "provider"
    ...
    Private Const m_def_Visible As Boolean = True
		...
		'Protected m_Color As Color = m_def_Color
		Protected m_Visible As Boolean = m_def_Visible
...
#Region "Clone"
		...
		Friend Overrides Function CloneMe() As Object
			Try
				Dim element As New Gravitybox.Objects.Provider
...
#Region "Property Implementations"
		...
		Obsolete("This property is not handled by the BackColor property of the Appearance object."), _
		...
		Public Property Color() As Color
			...
			Set(ByVal Value As Color)
				If Not Me.Appearance.BackColor.Equals(Value) Then
    ...
    End Function
		...
		Friend Overloads Overrides Function FromXML(ByVal xml As String, ByVal shallow As Boolean, ByVal cancelEvents As Boolean) As Boolean
			...
			Try
				...
				Me.Appearance.BackColor = System.Drawing.Color.FromArgb(GetIntlInteger(GetNodeValue(XMLDoc, startXPath & "color", Me.Appearance.BackColor.ToArgb.ToString)))

				Call ResetTimeStamp(False)
