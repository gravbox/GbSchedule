...
Namespace Gravitybox.Objects
  ...
  TypeConverter(GetType(Gravitybox.Design.Converters.CategoryConverter))> _
...
#Region "Class Members"
    ...
    'Private Constants
    Friend Const MyXMLNodeName As String = "category"
...
#Region "Clone"
		...
		Friend Overrides Function CloneMe() As Object
			Try
				Dim element As New Gravitybox.Objects.Category
