...
Namespace Gravitybox.Objects
  ...
  <Serializable(), _
  Editor(GetType(Gravitybox.Design.Editors.RoomCollectionUITypeEditor), GetType(System.Drawing.Design.UITypeEditor)), _
...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "roomcollection"
...
#Region "Constructor"
    ...
    Friend Sub New(ByVal mainobject As Gravitybox.Controls.Schedule)
      ...
      Me.ObjectSingular = "Room"
      Me.ObjectPlural = "Rooms"
...
#Region "Add Methods"
    ...
    ''' Adds a new object to the collection.
    ''' </summary>
    ''' <param name="room">This object to add to this collection.</param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal room As Room) As Room
      Return CType(AddObject(room), room)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal room As Room, ByVal index As Integer) As Room
      Return CType(AddObject(room, index), Room)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String) As Room
      Return Add(key, "", -1)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String) As Room
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal index As Integer) As Room

      Dim newObject As New Room
      ...
      Try
        ...
        Call newObject.SetKey(key)
        Return CType(AddObject(newObject, index), Room)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
      Return Nothing
...
#Region "VisibleList"
    ...
    Public ReadOnly Property VisibleList() As ArrayList
      Get
        ...
        For Each room As Gravitybox.Objects.Room In Me
...
#Region "Item"
    ...
    Default Public Shadows ReadOnly Property Item(ByVal key As String) As Gravitybox.Objects.Room
      Get
        Return CType(MyBase.Item(key), Room)
      End Get
    End Property
    ...
    Default Public Shadows ReadOnly Property Item(ByVal index As Integer) As Gravitybox.Objects.Room
      Get
        Return CType(MyBase.Item(index), Room)
      End Get
    End Property
...
#Region "IndexOfVisible"
    ...
    Public Function IndexOfVisible(ByVal item As Gravitybox.Objects.Room) As Integer

      If item Is Nothing Then Return -1
      Dim index As Integer
      For Each loopRoom As Gravitybox.Objects.Room In Me
        If (item Is loopRoom) AndAlso (item.Visible) Then
          Return index
        End If
        If loopRoom.Visible Then
          index += 1
        End If
      Next
      Return -1
...
#Region "AfterRemoveHandler"
    ...
    Private Sub AfterRemoveHandler(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.AfterBaseObjectEventArgs)
      Dim element As Room = CType(e.BaseObject, Room)
...
#Region "Methods"
    ...
    Friend Function MaxLineCount() As Integer
      ...
      Try
        ...
        For Each room As Gravitybox.Objects.Room In Me
          Dim s As String = room.Text.Replace(vbCr, "")
          Dim length As Integer = room.Text.Length - s.Length + 1
    ...
    Friend Function GetLeftMarginWidth(ByVal g As Graphics, ByVal font As Font) As Integer
      ...
      Try
        For Each room In Me
          length = GetIntlInteger(g.MeasureString(room.Text, font).Width)
          If retval < length Then retval = length
        Next
        Return retval
      Catch ex As Exception
...
#Region "CleanAppointments"
    ...
    Private Sub CleanAppointments()
      ...
      Try
        ...
        'ALL references to ALL Room objects 
    ...
    Private Sub CleanAppointments(ByVal Room As Room)
      ...
      Try
        ...
        'references the Room object that was just removed
        For Each appointment As Gravitybox.Objects.Appointment In MainObject.AppointmentCollection
          If appointment.Room Is Room Then
            appointment.Room = Nothing
          End If
        Next
...
#Region "ToList"
    ...
    ''' </summary>
    Public Function ToList() As Gravitybox.Objects.RoomList

      Try
        Dim list As New Gravitybox.Objects.RoomList(Me.MainObject, Me)
        Return list
      Catch ex As Exception
    ...
    Public Sub FromList(ByVal list As Gravitybox.Objects.RoomList)
...
#Region "Find"
    ...
    Public Function Find(ByVal text As String) As RoomList

      Try
        Dim element As Gravitybox.Objects.Room
        Dim retval As New RoomList(Me.MainObject)
