...
Namespace Gravitybox.Objects
  ...
  <Serializable(), _
  Editor(GetType(Gravitybox.Design.Editors.AppointmentTypeCollectionUITypeEditor), GetType(System.Drawing.Design.UITypeEditor)), _
...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "AppointmentTypecollection"
...
#Region "Constructor"
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      Me.ObjectSingular = "AppointmentType"
...
#Region "Add Methods"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add() As AppointmentType
    ...
    ''' Adds a new object to the collection.
    ''' </summary>
    ''' <param name="AppointmentType">This object to add to this collection.</param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal AppointmentType As AppointmentType) As AppointmentType
      Return CType(AddObject(AppointmentType), Gravitybox.Objects.AppointmentType)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal AppointmentType As AppointmentType, ByVal index As Integer) As AppointmentType
      Return CType(AddObject(AppointmentType, index), Gravitybox.Objects.AppointmentType)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Friend Function Add(ByVal key As String) As AppointmentType
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal index As Integer) As AppointmentType
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String) As AppointmentType
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal index As Integer) As AppointmentType
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal color As Color) As AppointmentType
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal color As Color, ByVal index As Integer) As AppointmentType

      Dim newObject As New Gravitybox.Objects.AppointmentType("")
      ...
      Try
        ...
        Call newObject.SetKey(key)
        Return CType(AddObject(newObject, index), AppointmentType)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
      Return Nothing
...
#Region "IndexOf"
    ...
    Default Public Shadows ReadOnly Property Item(ByVal key As String) As Gravitybox.Objects.AppointmentType
      Get
        Return CType(MyBase.Item(key), AppointmentType)
      End Get
    End Property
    ...
    Default Public Shadows ReadOnly Property Item(ByVal index As Integer) As Gravitybox.Objects.AppointmentType
      Get
        Return CType(MyBase.Item(index), AppointmentType)
      End Get
    End Property
...
#Region "AfterRemoveHandler"
    ...
    Private Sub AfterRemoveHandler(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.AfterBaseObjectEventArgs)
      Dim element As AppointmentType = CType(e.BaseObject, AppointmentType)
...
#Region "CleanAppointments"
    ...
    Private Sub CleanAppointments(ByVal AppointmentType As AppointmentType)
      ...
      Try
        ...
        'references the AppointmentType object that was just removed 
        For Each appointment As Gravitybox.Objects.Appointment In MainObject.AppointmentCollection
          If appointment.AppointmentType Is AppointmentType Then
            appointment.AppointmentType = Nothing
          End If
        Next
...
#Region "ToList"
    ...
    ''' </summary>
    Public Function ToList() As Gravitybox.Objects.AppointmentTypeList

      Try
        Dim list As New Gravitybox.Objects.AppointmentTypeList(Me.MainObject, Me)
        Return list
      Catch ex As Exception
    ...
    Public Sub FromList(ByVal list As Gravitybox.Objects.AppointmentTypeList)
...
#Region "Find"
    ...
    Public Function Find(ByVal text As String) As AppointmentTypeList

      Try
        Dim element As Gravitybox.Objects.AppointmentType
        Dim retval As New AppointmentTypeList(Me.MainObject)
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          Dim newElement As New Gravitybox.Objects.AppointmentType("")
