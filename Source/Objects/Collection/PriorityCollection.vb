...
Namespace Gravitybox.Objects
  ...
  <Serializable(), _
  Editor(GetType(Gravitybox.Design.Editors.PriorityCollectionUITypeEditor), GetType(System.Drawing.Design.UITypeEditor)), _
...
#Region "Class Members"
    ...
    Friend Const MyXMLNodeName As String = "Prioritycollection"
...
#Region "Constructor"
    ...
    Friend Sub New(ByVal mainObject As Gravitybox.Controls.Schedule)
      ...
      Me.ObjectSingular = "Priority"
			Me.ObjectPlural = "Priorities"
...
#Region "Add Methods"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add() As Priority
    ...
    ''' Adds a new object to the collection.
    ''' </summary>
    ''' <param name="priority">This object to add to this collection.</param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal priority As Priority) As Priority
      Return CType(AddObject(Priority), Gravitybox.Objects.Priority)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal priority As Priority, ByVal index As Integer) As Priority
      Return CType(AddObject(Priority, index), Gravitybox.Objects.Priority)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Friend Function Add(ByVal key As String) As Priority
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal index As Integer) As Priority
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String) As Priority
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal index As Integer) As Priority
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal color As Color) As Priority
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Add(ByVal key As String, ByVal text As String, ByVal color As Color, ByVal index As Integer) As Priority

      Dim newObject As New Gravitybox.Objects.Priority("")
      ...
      Try
        ...
        Call newObject.SetKey(key)
        Return CType(AddObject(newObject, index), Priority)
      Catch ex As Exception
        Call ErrorModule.SetErr(ex)
      End Try
      Return Nothing
...
#Region "IndexOf"
    ...
    Default Public Shadows ReadOnly Property Item(ByVal key As String) As Gravitybox.Objects.Priority
      Get
        Return CType(MyBase.Item(key), Priority)
      End Get
    End Property
    ...
    Default Public Shadows ReadOnly Property Item(ByVal index As Integer) As Gravitybox.Objects.Priority
      Get
        Return CType(MyBase.Item(index), Priority)
      End Get
    End Property
...
#Region "AfterRemoveHandler"
    ...
    Private Sub AfterRemoveHandler(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.AfterBaseObjectEventArgs)
      Dim element As Priority = CType(e.BaseObject, Priority)
...
#Region "CleanAppointments"
    ...
    Private Sub CleanAppointments()
      ...
      Try
        ...
        'ALL references to ALL Priority objects 
    ...
    Private Sub CleanAppointments(ByVal priority As Priority)
      ...
      Try
        ...
        'references the Priority object that was just removed 
        For Each appointment As Gravitybox.Objects.Appointment In MainObject.AppointmentCollection
          If appointment.Priority Is priority Then
            appointment.Priority = Nothing
          End If
        Next
...
#Region "ToList"
    ...
    ''' </summary>
    Public Function ToList() As Gravitybox.Objects.PriorityList

      Try
        Dim list As New Gravitybox.Objects.PriorityList(Me.MainObject, Me)
        Return list
      Catch ex As Exception
    ...
    Public Sub FromList(ByVal list As Gravitybox.Objects.PriorityList)
...
#Region "Find"
    ...
    Public Function Find(ByVal text As String) As PriorityList

      Try
        Dim element As Gravitybox.Objects.Priority
        Dim retval As New PriorityList(Me.MainObject)
    ...
    Public Overrides Function FromXML(ByVal xml As String) As Boolean
      ...
      Try
        ...
        For Each xmlNode In XMLDoc.DocumentElement.ChildNodes
          Dim newElement As New Gravitybox.Objects.Priority("")
