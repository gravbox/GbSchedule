...
Namespace Objects
  ...
  Public Class StudentItem
    ...
    <NonSerialized()> Private m_Parent As StudentItems

    'Internal method to set the parent pointer
    Friend Sub SetParent(ByVal NewParent As StudentItems)
      m_Parent = NewParent
    End Sub
    ...
    'The Parent Pointer
    <System.ComponentModel.Browsable(False)> _
    Public ReadOnly Property Parent() As StudentItems
      Get
        Return m_Parent
      End Get
    End Property
    ...
    Public Function Clone() As StudentItem
      Try
        Dim element As StudentItem = DirectCast(CloneObject(Me), StudentItem)
