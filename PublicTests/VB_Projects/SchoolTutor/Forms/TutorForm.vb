...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(TutorForm))
...
#End Region
    ...
    Private m_TutorItems As TutorItems
    Private WorkingTutorItems As New TutorItems()

    Public Property TutorItems() As TutorItems
      Get
        Return m_TutorItems
      End Get
      Set(ByVal Value As TutorItems)
        m_TutorItems = Value

        Try
          'Load a working collection with objects
          Call WorkingTutorItems.FromXML(Me.TutorItems.ToXML)
          Call RefreshForm()
    ...
    Private Sub RefreshForm()
      ...
      Try
        Dim tutor As TutorItem
        Call Me.lstMembers.Items.Clear()
        For Each tutor In Me.WorkingTutorItems
          Call Me.lstMembers.Items.Add(tutor.ToString)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Dim tutor As TutorItem = WorkingTutorItems(index)
        Call WorkingTutorItems.RemoveAt(index)
        Call WorkingTutorItems.AddObject(tutor, index - 1)
        Call RefreshForm()
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        Dim tutor As TutorItem = WorkingTutorItems.Add("", GetNewName, "")
        Call Me.lstMembers.Items.Add(tutor.ToString)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(tutor.Index)
      Catch ex As Exception
        Call SetErr(ex)
      End Try
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
      ...
      Try
        If Not (Me.lstMembers.SelectedItem Is Nothing) Then
          ...
          Me.WorkingTutorItems.RemoveAt(index)
          Call RefreshForm()
    ...
    Private Sub TutorForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveForm()
      ...
      Try
        Call TutorItems.FromXML(WorkingTutorItems.ToXML)
      Catch ex As Exception
        Call SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Const BaseName As String = "Tutor"
        Dim ii As Integer = 1
        Dim text As String
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal tutorIndex As Integer)

      Try
        'Index Key, Parent, PropertyItems
        Me.PropertyGrid1.SelectedObject = WorkingTutorItems(tutorIndex)
      Catch ex As Exception
        Call SetErr(ex)
      End Try
