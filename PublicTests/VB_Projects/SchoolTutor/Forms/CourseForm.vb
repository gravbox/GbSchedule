...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(CourseForm))
...
#End Region
    ...
    Private m_CourseItems As CourseItems
    Private WorkingCourseItems As New CourseItems()

    Public Property CourseItems() As CourseItems
      Get
        Return m_CourseItems
      End Get
      Set(ByVal Value As CourseItems)
        m_CourseItems = Value

        Try
          'Load a working collection with objects
          Call WorkingCourseItems.FromXML(Me.CourseItems.ToXML)
          Call RefreshForm()
    ...
    Private Sub RefreshForm()
      ...
      Try
        Dim course As CourseItem
        Call Me.lstMembers.Items.Clear()
        For Each course In Me.WorkingCourseItems
          Call Me.lstMembers.Items.Add(course.Text)
        Next
        Call EnableButtons()
      Catch ex As Exception
        Call SetErr(ex)
    ...
    Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
      ...
      Try
        ...
        Dim course As CourseItem = WorkingCourseItems(index)
        Call WorkingCourseItems.RemoveAt(index)
        Call WorkingCourseItems.AddObject(course, index - 1)
        Call RefreshForm()
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
      ...
      Try
        Dim course As CourseItem = WorkingCourseItems.Add("", GetNewName)
        Call Me.lstMembers.Items.Add(course.Text)
        Me.lstMembers.SelectedItem = Me.lstMembers.Items(course.Index)
      Catch ex As Exception
        Call SetErr(ex)
      End Try
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
      ...
      Try
        If Not (Me.lstMembers.SelectedItem Is Nothing) Then
          ...
          Me.WorkingCourseItems.RemoveAt(index)
          Call RefreshForm()
    ...
    Private Sub SaveForm()
      ...
      Try
        Call CourseItems.FromXML(WorkingCourseItems.ToXML)
      Catch ex As Exception
        Call SetErr(ex)
      End Try
    ...
    Private Function GetNewName() As String
      ...
      Try
        Const BaseName As String = "Course"
        Dim ii As Integer = 1
        Dim text As String
        text = BaseName & ii
    ...
    Private Sub LoadObject(ByVal courseIndex As Integer)

      Try
        'Index Key, Parent, PropertyItems
        Me.PropertyGrid1.SelectedObject = WorkingCourseItems(courseIndex)
      Catch ex As Exception
        Call SetErr(ex)
      End Try
