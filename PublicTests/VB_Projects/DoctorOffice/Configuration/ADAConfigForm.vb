...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ADAConfigForm))
...
#End Region
  ...
  Private m_ADACodeCollection As ADACodeCollection
  Private WorkingADACodeCollection As New ADACodeCollection()

  Public Property ADACodeCollection() As ADACodeCollection
    Get
      Return m_ADACodeCollection
    End Get
    Set(ByVal Value As ADACodeCollection)
      m_ADACodeCollection = Value

      Try
        'Load a working collection with objects
        Call WorkingADACodeCollection.FromXML(Me.ADACodeCollection.ToXML)
        Call RefreshForm()
  ...
  Private Sub RefreshForm()
    ...
    Try
      ...
      For Each ADA In Me.WorkingADACodeCollection
        Call Me.lstMembers.Items.Add(ADA.Text)
      Next
      Call EnableButtons()
    Catch ex As Exception
      Call SetErr(ex)
  ...
  Private Sub cmdUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUp.Click
    ...
    Try
      ...
      Dim ADA As ADACodeItem = WorkingADACodeCollection(index)
      Call WorkingADACodeCollection.RemoveAt(index)
      Call WorkingADACodeCollection.AddObject(ADA, index - 1)
      Call RefreshForm()
  ...
  Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
    ...
    Try
      Dim ADA As ADACodeItem = WorkingADACodeCollection.Add("", GetNewName)
      Call Me.lstMembers.Items.Add(ADA.Text)
      Me.lstMembers.SelectedItem = Me.lstMembers.Items(ADA.Index)
    Catch ex As Exception
      Call SetErr(ex)
    End Try
  ...
  Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
    ...
    Try
      If Not (Me.lstMembers.SelectedItem Is Nothing) Then
        ...
        Me.WorkingADACodeCollection.RemoveAt(index)
        Call RefreshForm()
  ...
  Private Sub ADAConfigForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Private Sub SaveForm()
    ...
    Try
      Call ADACodeCollection.FromXML(WorkingADACodeCollection.ToXML)
    Catch ex As Exception
      Call SetErr(ex)
    End Try
  ...
  Private Sub LoadObject(ByVal ADAIndex As Integer)

    Try
      'Index Key, Parent, PropertyItems
      Me.PropertyGrid1.SelectedObject = WorkingADACodeCollection(ADAIndex)
    Catch ex As Exception
      Call SetErr(ex)
    End Try
  ...
  Private Sub PropertyGrid1_PropertyValueChanged(ByVal s As Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles PropertyGrid1.PropertyValueChanged
    ...
    Try
      If lstMembers.SelectedIndex <> -1 Then
        Dim index As Integer = lstMembers.SelectedIndex
        Dim text As String = Me.WorkingADACodeCollection(lstMembers.SelectedIndex).Text
        If (CType(lstMembers.SelectedItem, String) <> text) Then
          lstMembers.Items.Insert(index, Me.WorkingADACodeCollection(lstMembers.SelectedIndex).Text)
