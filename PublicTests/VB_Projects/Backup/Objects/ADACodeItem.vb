...
Namespace Objects
  ...
  <Serializable()> _
  Public Class ADACodeItem
    Implements ICloneable

    'Private Member Variables
    Private m_Key As String
    <NonSerialized()> Private m_Parent As ADACodeCollection
    ...
    Public Property Index() As Integer
      ...
      Set(ByVal Value As Integer)
        Dim ii As Integer
        Dim MyParent As ADACodeCollection
    ...
    'The Parent Pointer
    <System.ComponentModel.Browsable(False)> _
    Public ReadOnly Property Parent() As ADACodeCollection
      Get
        Return m_Parent
      End Get
    End Property
    ...
    Friend Sub SetParent(ByVal NewParent As ADACodeCollection)
      m_Parent = NewParent
    End Sub
    ...
    Public Function Clone() As Object Implements System.ICloneable.Clone
      Dim element As ADACodeItem = DirectCast(CloneObject(Me), ADACodeItem)
