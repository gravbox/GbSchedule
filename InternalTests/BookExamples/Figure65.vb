...
#End Region
  ...
  Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    appointment = Schedule1.AppointmentCollection.Add("", #1/13/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Katy Smith"
    appointment = Schedule1.AppointmentCollection.Add("", #1/15/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Joe Williams"
    appointment = Schedule1.AppointmentCollection.Add("", #1/8/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Suzy Becker"
    appointment = Schedule1.AppointmentCollection.Add("", #1/20/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Natalia Johnson"
    appointment = Schedule1.AppointmentCollection.Add("", #1/20/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Becky Sloan"
