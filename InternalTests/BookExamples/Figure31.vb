...
#End Region
  ...
  Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    'Add Categories
    Call Schedule1.CategoryCollection.Add("", "Category I")
    Call Schedule1.CategoryCollection.Add("", "Category II")
    Call Schedule1.CategoryCollection.Add("", "Category III")

    'Add Providers
    Call Schedule1.ProviderCollection.Add("", "Provider I")
    Call Schedule1.ProviderCollection.Add("", "Provider II")
    Call Schedule1.ProviderCollection.Add("", "Provider III")
    ...
    appointment = Schedule1.AppointmentCollection.Add("", #1/1/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Sally Johnson"
    appointment.Text = "Sales Meeting!"
  ...
  Private Sub Schedule1_BeforePropertyDialog(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.BeforePropertyDialogEventArgs) Handles Schedule1.BeforePropertyDialog
    e.DialogSettings.AllowFlag = False
    e.DialogSettings.AllowModal = False
  End Sub
