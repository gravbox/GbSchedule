...
#End Region
  ...
  Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Call Schedule1.NoDropAreaCollection.Add(Color.Red, #1/8/2004#)
    Call Schedule1.NoDropAreaCollection.Add(Color.Red, #1/9/2004#)

    Call Schedule1.Visibility.ShowDate(#1/7/2004#)
