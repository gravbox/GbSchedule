...
#End Region
  ...
  Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    'Add Categories
    Call Schedule1.CategoryCollection.Add("", "Category I", Color.Blue)
    Call Schedule1.CategoryCollection.Add("", "Category II", Color.Yellow)
    Call Schedule1.CategoryCollection.Add("", "Category III", Color.LightGreen)

    'Add Appointments
    Dim appointment As Gravitybox.Objects.Appointment
    appointment = Schedule1.AppointmentCollection.Add("", #1/1/2004#, #8:00:00 AM#, 60)
    appointment.Subject = "Appt1"
