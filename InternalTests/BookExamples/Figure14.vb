...
#End Region
  ...
  Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    'Setup the Schedule
    Call Schedule1.SetMinMaxDate(#1/7/2004#, #1/10/2004#)
    Schedule1.StartTime = #8:00:00 AM#
    Schedule1.DayLength = 10
    Schedule1.ColumnHeader.Size = 60
    ...
    'Add Categories
    Call Schedule1.ProviderCollection.Add("", "John", Color.Blue)
    Call Schedule1.ProviderCollection.Add("", "Sue", Color.Yellow)
    Call Schedule1.ProviderCollection.Add("", "Fred", Color.Red)
    Call Schedule1.ProviderCollection.Add("", "Jane", Color.Green)

    'Add Appointments
    Dim appointment As Gravitybox.Objects.Appointment
    appointment = Schedule1.AppointmentCollection.Add("", #1/8/2004#, #9:00:00 AM#, 60)
