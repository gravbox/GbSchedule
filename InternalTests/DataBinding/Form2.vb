...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.Schedule1.Size = New System.Drawing.Size(647, 296)
...
#End Region
  ...
  Private _connectionString As String = "data source=gravtop2;database=Gravitybox2;uid=sa;pwd=;"
  ...
  Public Sub DatabaseConnect()
    ...
    Dim ds As DataSet = Me.ScheduleDomainController1.GetScheduleDataSet(AccountId)
  ...
  Private Sub Schedule1_DataSourceUpdated(ByVal sender As Object, ByVal e As System.EventArgs)
  ...
  Private Sub Schedule1_ColumnHeaderClick(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.AfterHeaderEventArgs)
    Beep()
  End Sub

  Private Sub Schedule1_AfterAppointmentRemove(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.AfterBaseObjectEventArgs)
  End Sub

  Private Sub Schedule1_BeforePropertyDialog(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.BeforePropertyDialogEventArgs)
    Beep()
  End Sub
  ...
  Private Sub Schedule1_AfterAppointmentAdd(ByVal sender As Object, ByVal e As Gravitybox.Objects.EventArgs.AfterBaseObjectEventArgs)
